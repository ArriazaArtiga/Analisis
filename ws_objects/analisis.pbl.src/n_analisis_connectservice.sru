$PBExportHeader$n_analisis_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_analisis_connectservice from nonvisualobject
end type
end forward

global type n_analisis_connectservice from nonvisualobject
end type
global n_analisis_connectservice n_analisis_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		//string ls_inifile = "C:\PPEM\Sistemas\Analisis\analisis.ini" //db_local
		string ls_inifile = "Z:\Analisis\analisis.ini" //db_servidor
		...
		//as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=PPEM;UID=sa;PWD=sqldata'") //db_local
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=PPEM_SERVER;UID=SIG;PWD=1Crtmlqn810$',CallEscape='No',StripParmNames='Yes'") //db_servidor
...
//			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=PPEM;UID=sa;PWD=sqldata'" )  //db_local
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=PPEM_SERVER;UID=SIG;PWD=1Crtmlqn810$',CallEscape='No',StripParmNames='Yes'" )  //db_servidor
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		//as_dbparm		= "ConnectString='DSN=PPEM;UID=sa;PWD=sqldata'" //db_local
		as_dbparm		= "ConnectString='DSN=PPEM_SERVER;UID=SIG;PWD=1Crtmlqn810$',CallEscape='No',StripParmNames='Yes'" //db_servidor
		as_lock			= ""
		as_autocommit	= "false"
...
on n_analisis_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_analisis_connectservice.destroy

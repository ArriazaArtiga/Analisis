$PBExportHeader$n_analisis_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_analisis_sheetmanager from nonvisualobject
end type
end forward

global type n_analisis_sheetmanager from nonvisualobject
end type
global n_analisis_sheetmanager n_analisis_sheetmanager

type variables
string is_sheets[], is_display[]
w_analisis_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_analisis_basesheet aw_sheet)
public function long of_classcount (readonly w_analisis_basesheet aw_sheet)
public function integer of_openallsheets ()
public function integer of_adjustmenu (ref m_analisis_frame am_menu)
...
//*-----------------------------------------------------------------*/
int li_rc
w_analisis_basesheet lw_sheet

/*  Open an instance of the specified sheet  */
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_analisis_frame, 0, Cascaded! ) 
...
w_analisis_basesheet lw_sheets[], lw_init[]
...
lm_menu = w_analisis_frame.MenuId
...
w_analisis_sheet1	lw_sheet1
w_analisis_sheet2	lw_sheet2
w_analisis_sheet3	lw_sheet3
...
on n_analisis_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_analisis_sheetmanager.destroy

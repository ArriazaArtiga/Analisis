$PBExportHeader$w_analisis_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_analisis_frame from window
end type
type mdi_1 from mdiclient within w_analisis_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_analisis_frame"
...
global w_analisis_frame w_analisis_frame

type variables
n_analisis_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_analisis_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_analisis_sheet1", "w_analisis_sheet2", "w_analisis_sheet3" }
...
inv_sheetmgt = Create n_analisis_sheetmanager
...
if this.MenuName = "m_analisis_frame" then this.MenuID = create m_analisis_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_analisis_frame.destroy

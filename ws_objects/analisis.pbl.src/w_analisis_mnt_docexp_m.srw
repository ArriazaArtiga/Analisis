$PBExportHeader$w_analisis_mnt_docexp_m.srw
...
global w_analisis_mnt_docexp_m w_analisis_mnt_docexp_m
...
on w_analisis_mnt_docexp_m.create
...
on w_analisis_mnt_docexp_m.destroy
destroy(this.cb_3)
destroy(this.dw_1)
destroy(this.cb_2)
destroy(this.cb_1)

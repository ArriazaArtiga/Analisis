$PBExportHeader$w_analisis_mnt_nominas_auxiliares.srw
$PBExportComments$Generated MDI About Box
forward
global type w_analisis_mnt_nominas_auxiliares from window
end type
type dw_nomina_aux from datawindow within w_analisis_mnt_nominas_auxiliares
end type
type st_1 from statictext within w_analisis_mnt_nominas_auxiliares
end type
type rb_dictamen_juridico from radiobutton within w_analisis_mnt_nominas_auxiliares
end type
type rb_dictamen_auditoria from radiobutton within w_analisis_mnt_nominas_auxiliares
end type
type rb_providencia from radiobutton within w_analisis_mnt_nominas_auxiliares
end type
type rb_liquidacion from radiobutton within w_analisis_mnt_nominas_auxiliares
end type
type rb_extraordinaria from radiobutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_buscar1 from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_4 from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_3 from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_2 from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_eliminar from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_grabar from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_nuevo from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_salir from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type pb_buscar from picturebutton within w_analisis_mnt_nominas_auxiliares
end type
type sle_buscar from singlelineedit within w_analisis_mnt_nominas_auxiliares
end type
type dw_nomina_enc from datawindow within w_analisis_mnt_nominas_auxiliares
end type
type gb_doctos from groupbox within w_analisis_mnt_nominas_auxiliares
end type
type dw_nominas_det from datawindow within w_analisis_mnt_nominas_auxiliares
end type
end forward
...
global w_analisis_mnt_nominas_auxiliares w_analisis_mnt_nominas_auxiliares
...
on w_analisis_mnt_nominas_auxiliares.create
...
this.Control[]={this.dw_nomina_aux,&
this.st_1,&
...
on w_analisis_mnt_nominas_auxiliares.destroy
...
event clicked;Close(w_analisis_mnt_nominas_auxiliares)
end event

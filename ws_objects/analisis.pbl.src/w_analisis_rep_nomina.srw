$PBExportHeader$w_analisis_rep_nomina.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_nomina from window
end type
type pb_1 from picturebutton within w_analisis_rep_nomina
end type
type pb_4 from picturebutton within w_analisis_rep_nomina
end type
type pb_salir from picturebutton within w_analisis_rep_nomina
end type
type pb_nuevo from picturebutton within w_analisis_rep_nomina
end type
type sle_buscar from singlelineedit within w_analisis_rep_nomina
end type
type pb_buscar from picturebutton within w_analisis_rep_nomina
end type
type pb_buscar1 from picturebutton within w_analisis_rep_nomina
end type
type st_1 from statictext within w_analisis_rep_nomina
end type
type dw_rep from datawindow within w_analisis_rep_nomina
end type
type gb_acciones from groupbox within w_analisis_rep_nomina
end type
end forward
...
global w_analisis_rep_nomina w_analisis_rep_nomina
...
on w_analisis_rep_nomina.create
...
on w_analisis_rep_nomina.destroy
destroy(this.pb_1)
destroy(this.pb_4)
...
event clicked;Close(w_analisis_rep_nomina)
end event

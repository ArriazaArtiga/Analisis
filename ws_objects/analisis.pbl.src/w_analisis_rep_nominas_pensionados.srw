$PBExportHeader$w_analisis_rep_nominas_pensionados.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_nominas_pensionados from window
end type
type pb_exportar from picturebutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_rtra from radiobutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_rpen from radiobutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_mj from radiobutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_ampl from radiobutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_extr from radiobutton within w_analisis_rep_nominas_pensionados
end type
type rb_nom_gral from radiobutton within w_analisis_rep_nominas_pensionados
end type
type em_nomina from editmask within w_analisis_rep_nominas_pensionados
end type
type st_1 from statictext within w_analisis_rep_nominas_pensionados
end type
type pb_imprimir from picturebutton within w_analisis_rep_nominas_pensionados
end type
type pb_salir from picturebutton within w_analisis_rep_nominas_pensionados
end type
type pb_2 from picturebutton within w_analisis_rep_nominas_pensionados
end type
type pb_3 from picturebutton within w_analisis_rep_nominas_pensionados
end type
type dw_report from datawindow within w_analisis_rep_nominas_pensionados
end type
type gb_acciones from groupbox within w_analisis_rep_nominas_pensionados
end type
type gb_doctos from groupbox within w_analisis_rep_nominas_pensionados
end type
end forward
...
global w_analisis_rep_nominas_pensionados w_analisis_rep_nominas_pensionados
...
on w_analisis_rep_nominas_pensionados.create
...
this.rb_nom_gral=create rb_nom_gral
...
on w_analisis_rep_nominas_pensionados.destroy
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_rtra_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_rpen_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	//pb_exportar.visible = false
End If
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_mj_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	//pb_exportar.visible = false
End If
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_ampl_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	//pb_exportar.visible = false
End If
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_extr_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	//pb_exportar.visible = false
End If
...
event clicked;If This.checked = True Then
	dw_report.DataObject = "d_analisis_rep_nom_gral_pen"
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	pb_exportar.visible = false
End If
...
event clicked;Close(w_analisis_rep_nominas_pensionados)
end event
...
integer taborder = 30
string title = "none"
string dataobject = "d_analisis_rep_nom_gral_pen"

$PBExportHeader$w_analisis_rep_sobreviv_presentadas.srw
$PBExportComments$Reporte Sobrevivencias Presentadas
forward
global type w_analisis_rep_sobreviv_presentadas from window
end type
type pb_buscar from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type pb_buscar1 from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type st_2 from statictext within w_analisis_rep_sobreviv_presentadas
end type
type pb_nuevo from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type pb_grabar from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type pb_2 from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type pb_3 from picturebutton within w_analisis_rep_sobreviv_presentadas
end type
type dw_report from datawindow within w_analisis_rep_sobreviv_presentadas
end type
type gb_acciones from groupbox within w_analisis_rep_sobreviv_presentadas
end type
type ddlb_mes from dropdownlistbox within w_analisis_rep_sobreviv_presentadas
end type
end forward
...
global w_analisis_rep_sobreviv_presentadas w_analisis_rep_sobreviv_presentadas
...
Integer ii_depto, ii_muni, ii_etapa, ii_mes
DataWindowChild idwch_muni
end variables

on w_analisis_rep_sobreviv_presentadas.create
...
on w_analisis_rep_sobreviv_presentadas.destroy
...
//if ii_etapa = 70 or ii_etapa = 80 then
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
	ll_rows = dw_report.retrieve(string(ii_mes))
	commit;
//end if
...
event clicked;Close(w_analisis_rep_sobreviv_presentadas)
end event
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_sobreviv_presentadas"

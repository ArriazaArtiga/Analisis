$PBExportHeader$w_analisis_rep_solic_x_tramite_et_100_110.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solic_x_tramite_et_100_110 from window
end type
type pb_buscar from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type pb_buscar1 from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type st_2 from statictext within w_analisis_rep_solic_x_tramite_et_100_110
end type
type em_listado from editmask within w_analisis_rep_solic_x_tramite_et_100_110
end type
type pb_nuevo from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type pb_grabar from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type pb_2 from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type pb_3 from picturebutton within w_analisis_rep_solic_x_tramite_et_100_110
end type
type dw_report from datawindow within w_analisis_rep_solic_x_tramite_et_100_110
end type
type gb_acciones from groupbox within w_analisis_rep_solic_x_tramite_et_100_110
end type
end forward
...
global w_analisis_rep_solic_x_tramite_et_100_110 w_analisis_rep_solic_x_tramite_et_100_110
...
on w_analisis_rep_solic_x_tramite_et_100_110.create
...
on w_analisis_rep_solic_x_tramite_et_100_110.destroy
...
choose case ii_etapa
	case 100  /* Rechazo AJ */
		dw_report.DataObject = "d_analisis_rep_solicitudes_etapa_100"
	case 110  /* Aprobado AJ */
		dw_report.DataObject = "d_analisis_rep_solicitudes_etapa_110"
	case else
		MessageBox ('¡¡ Precuación !!', 'Solo puede ingresar los números de etapa 100 o 110 para visualizar el reporte', Exclamation!, OK! )
end choose

if ii_etapa = 100 or ii_etapa = 110 then
	dw_report.SetTransObject(sqlca)
	dw_report.Modify("DataWindow.Print.Preview=Yes")
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_solicitudes_etapa_110"

$PBExportHeader$w_analisis_rep_solic_x_tramite_etapa_180.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solic_x_tramite_etapa_180 from window
end type
type cb_1 from commandbutton within w_analisis_rep_solic_x_tramite_etapa_180
end type
type st_2 from statictext within w_analisis_rep_solic_x_tramite_etapa_180
end type
type em_listado from editmask within w_analisis_rep_solic_x_tramite_etapa_180
end type
type em_fecha from editmask within w_analisis_rep_solic_x_tramite_etapa_180
end type
type st_1 from statictext within w_analisis_rep_solic_x_tramite_etapa_180
end type
type pb_nuevo from picturebutton within w_analisis_rep_solic_x_tramite_etapa_180
end type
type pb_grabar from picturebutton within w_analisis_rep_solic_x_tramite_etapa_180
end type
type pb_2 from picturebutton within w_analisis_rep_solic_x_tramite_etapa_180
end type
type pb_3 from picturebutton within w_analisis_rep_solic_x_tramite_etapa_180
end type
type dw_report from datawindow within w_analisis_rep_solic_x_tramite_etapa_180
end type
type gb_acciones from groupbox within w_analisis_rep_solic_x_tramite_etapa_180
end type
end forward
...
global w_analisis_rep_solic_x_tramite_etapa_180 w_analisis_rep_solic_x_tramite_etapa_180
...
on w_analisis_rep_solic_x_tramite_etapa_180.create
...
on w_analisis_rep_solic_x_tramite_etapa_180.destroy
destroy(this.cb_1)
destroy(this.st_2)
...
dw_report.retrieve(integer(em_listado.text),datetime(em_fecha.text))
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_solic_etapa_180fecha"

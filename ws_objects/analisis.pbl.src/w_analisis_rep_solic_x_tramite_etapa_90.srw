$PBExportHeader$w_analisis_rep_solic_x_tramite_etapa_90.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solic_x_tramite_etapa_90 from window
end type
type pb_nuevo from picturebutton within w_analisis_rep_solic_x_tramite_etapa_90
end type
type pb_grabar from picturebutton within w_analisis_rep_solic_x_tramite_etapa_90
end type
type pb_2 from picturebutton within w_analisis_rep_solic_x_tramite_etapa_90
end type
type pb_3 from picturebutton within w_analisis_rep_solic_x_tramite_etapa_90
end type
type dw_report from datawindow within w_analisis_rep_solic_x_tramite_etapa_90
end type
type gb_acciones from groupbox within w_analisis_rep_solic_x_tramite_etapa_90
end type
end forward
...
global w_analisis_rep_solic_x_tramite_etapa_90 w_analisis_rep_solic_x_tramite_etapa_90
...
on w_analisis_rep_solic_x_tramite_etapa_90.create
...
on w_analisis_rep_solic_x_tramite_etapa_90.destroy
...
event clicked;Close(w_analisis_rep_solic_x_tramite_etapa_90)
end event
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_solicitudes_etapa_90"

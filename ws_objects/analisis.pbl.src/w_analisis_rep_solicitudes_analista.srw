$PBExportHeader$w_analisis_rep_solicitudes_analista.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solicitudes_analista from window
end type
type pb_nuevo from picturebutton within w_analisis_rep_solicitudes_analista
end type
type pb_grabar from picturebutton within w_analisis_rep_solicitudes_analista
end type
type pb_2 from picturebutton within w_analisis_rep_solicitudes_analista
end type
type pb_3 from picturebutton within w_analisis_rep_solicitudes_analista
end type
type dw_report from datawindow within w_analisis_rep_solicitudes_analista
end type
type gb_acciones from groupbox within w_analisis_rep_solicitudes_analista
end type
end forward
...
string title = ".:. PPEM SIG - Módulo Análisis - Reporte de solicitudes por etapa .:."
...
global w_analisis_rep_solicitudes_analista w_analisis_rep_solicitudes_analista
...
on w_analisis_rep_solicitudes_analista.create
...
on w_analisis_rep_solicitudes_analista.destroy
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_analista_solicitudes"

$PBExportHeader$w_analisis_rep_solicitudes_analista_cambio.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solicitudes_analista_cambio from window
end type
type pb_nuevo from picturebutton within w_analisis_rep_solicitudes_analista_cambio
end type
type pb_grabar from picturebutton within w_analisis_rep_solicitudes_analista_cambio
end type
type pb_2 from picturebutton within w_analisis_rep_solicitudes_analista_cambio
end type
type pb_3 from picturebutton within w_analisis_rep_solicitudes_analista_cambio
end type
type dw_report from datawindow within w_analisis_rep_solicitudes_analista_cambio
end type
type gb_acciones from groupbox within w_analisis_rep_solicitudes_analista_cambio
end type
end forward
...
global w_analisis_rep_solicitudes_analista_cambio w_analisis_rep_solicitudes_analista_cambio
...
on w_analisis_rep_solicitudes_analista_cambio.create
...
on w_analisis_rep_solicitudes_analista_cambio.destroy
...
event clicked;Close(w_analisis_rep_solicitudes_analista_cambio)
end event
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_resumen_cambios_etapas_solicitudes"

$PBExportHeader$w_analisis_rep_solicitudes_resumen_etapas.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solicitudes_resumen_etapas from window
end type
type pb_nuevo from picturebutton within w_analisis_rep_solicitudes_resumen_etapas
end type
type pb_grabar from picturebutton within w_analisis_rep_solicitudes_resumen_etapas
end type
type pb_2 from picturebutton within w_analisis_rep_solicitudes_resumen_etapas
end type
type pb_3 from picturebutton within w_analisis_rep_solicitudes_resumen_etapas
end type
type dw_report from datawindow within w_analisis_rep_solicitudes_resumen_etapas
end type
type gb_acciones from groupbox within w_analisis_rep_solicitudes_resumen_etapas
end type
end forward
...
global w_analisis_rep_solicitudes_resumen_etapas w_analisis_rep_solicitudes_resumen_etapas
...
on w_analisis_rep_solicitudes_resumen_etapas.create
...
on w_analisis_rep_solicitudes_resumen_etapas.destroy
...
event clicked;Close(w_analisis_rep_solicitudes_resumen_etapas)
end event
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_solicitud_resumen_etapas_expediente"

$PBExportHeader$w_analisis_rep_solicitudes_tramite.srw
$PBExportComments$Mantenimiento Departamentos
forward
global type w_analisis_rep_solicitudes_tramite from window
end type
type pb_nuevo from picturebutton within w_analisis_rep_solicitudes_tramite
end type
type pb_grabar from picturebutton within w_analisis_rep_solicitudes_tramite
end type
type pb_2 from picturebutton within w_analisis_rep_solicitudes_tramite
end type
type pb_3 from picturebutton within w_analisis_rep_solicitudes_tramite
end type
type dw_report from datawindow within w_analisis_rep_solicitudes_tramite
end type
type gb_acciones from groupbox within w_analisis_rep_solicitudes_tramite
end type
end forward
...
global w_analisis_rep_solicitudes_tramite w_analisis_rep_solicitudes_tramite
...
on w_analisis_rep_solicitudes_tramite.create
...
on w_analisis_rep_solicitudes_tramite.destroy
...
event clicked;Close(w_analisis_rep_solicitudes_tramite)
end event
...
integer taborder = 20
string title = "none"
string dataobject = "d_analisis_rep_solicitudes_x_tramite"
